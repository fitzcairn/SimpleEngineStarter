...
public final class WallBottomLeftCorner extends Obstacle {

  public WallBottomLeftCorner(Loader loader, int x, int y, int fill) {
    super(loader, x, y);
    
    sprite.setAnimationTo(sprite.addAnimation(new WallRest(loader, Direction.LEFT, Direction.DOWN, fill)));
  }
}
