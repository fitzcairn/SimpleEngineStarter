package com.stevezero.apps.simplegamestarter.game.engine.actor.enemy.impl;
...
import com.stevezero.apps.simplegamestarter.game.engine.ai.processor.impl.RTSEnemyProcessor;
import com.stevezero.apps.simplegamestarter.game.engine.graphics.motion.animation.impl.EnemyDeath;
import com.stevezero.apps.simplegamestarter.game.engine.graphics.motion.animation.impl.EnemyRest;


public final class Jarlsberg extends Enemy {
  ...
  public Jarlsberg(Engine engine, int x, int y) {
    ...
    moveSoundId = engine.addSound("jarlsberg.wav");
  }
