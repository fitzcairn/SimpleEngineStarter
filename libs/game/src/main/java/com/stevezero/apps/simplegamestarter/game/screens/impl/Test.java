package com.stevezero.apps.simplegamestarter.game.screens.impl;
 ...
 */
public class Test extends Screen implements Interactable {
  ...
  public Test(Game game, Manifest manifest) {
    super(game, manifest);
  }
  ...
  public void registerControls() {
    game.getControlHandler().registerEvent(EventType.MENU_SELECT, new ControlEvent() {
      @Override
      public void onEvent() {
        //manifest.setScreen(game, GMSCrusader.MENU);
      }
    });
  }
