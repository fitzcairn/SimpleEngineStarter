...
/**
 * Animation state for a player ducking.  Has no animation.
 */
public final class PlayerDuck extends Animation {
  ...
  public PlayerDuck(Loader loader, Direction direction) {
    super(AssetManager.getDrawable(loader, "atlas_thrillson.png"), WIDTH_PX, HEIGHT_PX, 1, true);
    this.direction = direction;   
  }

  private int getY() {
    return (4 + direction.getOrdinal()) * HEIGHT_PX;
  }
