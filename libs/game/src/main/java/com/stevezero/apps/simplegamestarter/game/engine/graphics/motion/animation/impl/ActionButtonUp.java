package com.stevezero.apps.simplegamestarter.game.engine.graphics.motion.animation.impl;

import com.stevezero.apps.simplegamestarter.game.controls.onscreen.impl.ActionButton;
 ...
 */
public final class ActionButtonUp extends Animation {
  private final int type;
  private static final Box2 BOX = new Box2();
  
  public ActionButtonUp(Loader loader, int type) {
  ...
  private static Box2 getBox(int type) {
    switch(type) {
      case(ActionButton.TYPE_LEFT):
        return BOX.set(130, 0, 130, 100);
      case(ActionButton.TYPE_RIGHT):
        return BOX.set(0, 0, 130, 100);
      case(ActionButton.TYPE_JUMP):
        return BOX.set(260, 0, 100, 130);
      case(ActionButton.TYPE_SHOOT):
      default:
        return BOX.set(460, 0, 110, 100);
    }
  }
