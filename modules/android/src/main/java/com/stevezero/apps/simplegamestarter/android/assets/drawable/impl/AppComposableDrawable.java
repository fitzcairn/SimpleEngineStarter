package com.stevezero.apps.simplegamestarter.android.assets.drawable.impl;
 ...
 */
public class AppComposableDrawable extends com.stevezero.apps.simplegamestarter.android.assets.drawable.impl.AppDrawable {
  ...
  public GameDrawable renderToCanvas(Canvas canvas, Paint paint, int x, int y) {
    com.stevezero.apps.simplegamestarter.android.assets.drawable.impl.AppDrawable drawable;
    for(Layer layer : layers) {
      drawable =  (com.stevezero.apps.simplegamestarter.android.assets.drawable.impl.AppDrawable)layer.drawable;
